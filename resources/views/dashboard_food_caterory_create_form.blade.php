  ...
  <main class="flex flex-grow">
    ...
    <div class="flex gap-20 py-12 px-10 mx-auto container align-middle">
      ...
      <div class="w-1/3 m-auto">
        ...
        <form action="{{ route('food_cat.store') }}" method="POST">
          ...
          <div class="space-y-7">
            ...
            <div class="flex gap-10 text-center">
              ...
              <a href="{{ route('food_cat.index') }}" class="w-1/3 py-3 rounded-xl border border-gray-600 text-gray-600 hover:bg-gray-600 hover:text-gray-50">
                Cancel
              </a>
